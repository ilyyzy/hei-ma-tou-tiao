  ...
  <div>
    ...
    <div class="article-container" v-if="article">
      ...
      <van-cell center :title="article.aut_name" :label="article.pubdate | dateFormat">
        ...
        <template #default>
          <div @click="article.is_followed = !article.is_followed">
            <!-- 是否关注了作者 -->
      ...
      <!-- 文章内容 -->
      <div class="art-content" v-html="article.content" v-if="article.content"></div>

      <!-- 分割线 -->
      <van-divider>End</van-divider>

      <!-- 点赞 -->
      <div class="like-box" @click="article.is_collected = !article.is_collected">
...
import ArtCmt from '@/components/ArtCmt'
